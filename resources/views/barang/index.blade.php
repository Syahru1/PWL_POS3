        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <a href="{{ url('/barang/export_excel') }}" class="btn btn-primary"><i class="fa fa-file excel"></i> Export
                    Barang</a>
                <a href="{{ url('/barang/export_pdf') }}" class="btn btn-danger"><i class="fa fa-file pdf"></i> Export
                    PDF</a>
                <button onclick="modalAction('{{ url(path: '/barang/create_ajax') }}')" class="btn btn-success">Tambah Data
                    (Ajax)</button>
            </div>
        </div>
        <div class="card-body">
