...
Route::group(['prefix' => 'level'], function () {
    ...
    Route::get('/{id}/delete_ajax', [LevelController::class, 'confirm_ajax']);   // Untuk tampilan form confirm delete user Ajax
...
Route::group(['prefix' => 'kategori'], function () {
    ...
    Route::get('/{id}/delete_ajax', [KategoriController::class, 'confirm_ajax']);   // Untuk tampilan form confirm delete user Ajax
...
Route::group(['prefix' => 'suplier'], function () {
    ...
    Route::get('/{id}/delete_ajax', [SupplierController::class, 'confirm_ajax']);   // Untuk tampilan form confirm delete user Ajax
...
Route::group(['prefix' => 'barang'], function () {
    ...
    Route::get('/{id}/delete_ajax', [BarangController::class, 'confirm_ajax']);   // Untuk tampilan form confirm delete user Ajax
